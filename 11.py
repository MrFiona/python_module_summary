...
# 100% error
error_mark_pattern = [(r"(No such file or directory|command not found|unknown option|invalid option)", COLOR_RED),
                      ...
                      (
                      r"(java.io.FileNotFoundException|org.apache.hadoop.mapred.InvalidInputException|java.lang.IllegalMonitorStateException)",
                      COLOR_RED),  # javaerror
                      ]
